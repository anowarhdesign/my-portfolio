...
def _home(uid):
    defs = _defs(uid)
    body = f'''
      <ellipse class="hv-floor" cx="200" cy="430" rx="140" ry="18"/>
      ...
      <circle cx="335" cy="100" r="3" fill="var(--ember)"/>
      <circle cx="350" cy="300" r="5" fill="var(--ember)"/>'''
    return _wrap(uid, defs, body)

# ───────────────────── services: four disciplines, stacked ─────────────────────
def _services(uid):
    defs = _defs(uid)
    body = f'''
      <ellipse class="hv-floor" cx="200" cy="560" rx="120" ry="14"/>
      <g filter="url(#{uid}-shadow)">
      ...
      <circle cx="100" cy="150" r="3" fill="var(--ember)"/>
      <circle cx="310" cy="440" r="4" fill="var(--ember)"/>'''
    return _wrap(uid, defs, body)
...
def _product_design(uid):
    defs = _defs(uid)
    body = f'''
      <ellipse class="hv-floor" cx="200" cy="520" rx="130" ry="16"/>
      <g filter="url(#{uid}-shadow)">
      ...
      <g filter="url(#{uid}-shadow)" transform="translate(272 372) rotate(-14)">
        <path d="M0 0 L0 46 L12 34 L22 56 L32 51 L22 29 L38 29 Z" fill="var(--ink)"/>
      </g>
      <circle cx="336" cy="150" r="4" fill="var(--ember)"/>
      <circle cx="80" cy="440" r="3" fill="var(--ember)"/>'''
    return _wrap(uid, defs, body)
...
def _webflow(uid):
    defs = _defs(uid)
    body = f'''
      <ellipse class="hv-floor" cx="200" cy="500" rx="130" ry="16"/>
      <g filter="url(#{uid}-shadow)">
      ...
      <circle cx="330" cy="440" r="30" fill="url(#{uid}-sphere)" filter="url(#{uid}-shadow)"/>
      <circle cx="60" cy="200" r="4" fill="var(--ember)"/>
      <circle cx="340" cy="150" r="3" fill="var(--ember)"/>'''
    return _wrap(uid, defs, body)
...
def _framer(uid):
    ...
    body = f'''
      ...
      <g filter="url(#{uid}-shadow)" transform="translate(120 360)">
        <path d="M0 40 L34 0 L34 24 L68 24 L68 56 L34 56 L34 80 Z" fill="var(--ink)" opacity=".9"/>
      </g>
      <circle cx="90" cy="150" r="4" fill="var(--ember)"/>
      <circle cx="330" cy="440" r="3" fill="var(--ember)"/>
      <circle cx="310" cy="120" r="5" fill="var(--ember-lift)"/>'''
    return _wrap(uid, defs, body)
...
def _ai_builds(uid):
    ...
    body = f'''
      ...
      <path d="M110 130 l6 16 16 6 -16 6 -6 16 -6 -16 -16 -6 16 -6 Z" fill="var(--ember-lift)"/>
      <path d="M330 460 l4 10 10 4 -10 4 -4 10 -4 -10 -10 -4 10 -4 Z" fill="var(--ember)"/>
      <circle cx="80" cy="440" r="3" fill="var(--ember)"/>'''
    return _wrap(uid, defs, body)
...
def _work(uid):
    defs = _defs(uid)
    body = f'''
      <ellipse class="hv-floor" cx="200" cy="520" rx="140" ry="16"/>
      <g filter="url(#{uid}-shadow)">
      ...
      <circle cx="90" cy="140" r="4" fill="var(--ember)"/>
      <circle cx="330" cy="440" r="3" fill="var(--ember)"/>
      <circle cx="70" cy="440" r="3" fill="var(--ember-lift)"/>'''
    return _wrap(uid, defs, body)
...
def _pricing(uid):
    ...
    body = f'''
      <ellipse class="hv-floor" cx="200" cy="500" rx="130" ry="16"/>
      <g filter="url(#{uid}-shadow)" transform="rotate(-8 200 250)">
      ...
      <circle cx="90" cy="150" r="4" fill="var(--ember)"/>
      <circle cx="330" cy="180" r="3" fill="var(--ember)"/>'''
    return _wrap(uid, defs, body)
...
def _process(uid):
    ...
    body = f'''
      <ellipse class="hv-floor" cx="200" cy="560" rx="120" ry="14"/>
      <path d="M120 500 C120 440 260 440 260 380 C260 320 120 320 120 260 C120 200 260 200 260 140"
        fill="none" stroke="var(--line-2)" stroke-width="4" stroke-dasharray="2 10" stroke-linecap="round"/>
      <g filter="url(#{uid}-shadow)">
        <circle cx="120" cy="500" r="20" fill="var(--paper-2)" stroke="var(--line-2)" stroke-width="1.5"/>
        <circle cx="260" cy="380" r="22" fill="url(#{uid}-glass)" stroke="var(--line-2)" stroke-width="1.5"/>
        <circle cx="120" cy="260" r="24" fill="url(#{uid}-soft)" stroke="var(--ember)" stroke-width="1.5"/>
        <circle cx="260" cy="140" r="30" fill="url(#{uid}-sphere)"/>
      </g>
      <circle cx="90" cy="440" r="3" fill="var(--ember)"/>
      <circle cx="320" cy="240" r="4" fill="var(--ember)"/>'''
    return _wrap(uid, defs, body)
...
def _contact(uid):
    ...
    body = f'''
      <ellipse class="hv-floor" cx="200" cy="500" rx="130" ry="16"/>
      <circle cx="200" cy="230" r="70" fill="none" stroke="var(--ember)" stroke-width="1.5" opacity=".35"/>
      <circle cx="200" cy="230" r="100" fill="none" stroke="var(--ember)" stroke-width="1.5" opacity=".2"/>
      <g filter="url(#{uid}-shadow)">
      ...
      <g filter="url(#{uid}-shadow)" transform="translate(150 400) rotate(-20)">
        <path d="M0 30 L110 0 L70 30 L110 60 Z" fill="var(--ink)" opacity=".9"/>
      </g>
      <circle cx="330" cy="440" r="4" fill="var(--ember)"/>
      <circle cx="70" cy="150" r="3" fill="var(--ember)"/>'''
    return _wrap(uid, defs, body)
