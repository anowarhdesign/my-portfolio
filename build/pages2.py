...
service_page(
 ...
 "Product design for SaaS and mobile teams: UX research, flows, wireframes and high-fidelity interface design in Figma, delivered developer-ready with a component system. A typical engagement runs four to eight weeks and costs $3,000&#8211;$7,000, designed against your business goals rather than a moodboard.",
 ...
 [("How long does a product design engagement take?",
   "Four to eight weeks for most SaaS and mobile projects. A focused audit and redesign of an existing flow can run two to three weeks; a full product with research, a design system and a prototype runs closer to eight."),
 ...
 "UX and interface design for SaaS and mobile products, delivered developer-ready in Figma. Four to eight weeks, $3,000-$7,000, fixed quote.",
...
service_page(
 ...
 "Production Webflow development for marketing sites: pixel-perfect builds from your design or mine, with an editor-proof CMS your marketing team runs alone. A 6&#8211;12 page site with CMS runs $2,500&#8211;$6,000 and takes four to six weeks, including migration, QA on every breakpoint and launch support.",
 ...
 [("How much does a Webflow website cost?",
   "A 6&#8211;12 page marketing site with a CMS runs $2,500&#8211;$6,000. A single landing page starts at $900. An enterprise site with many templates, heavy migration and integrations runs higher; you get a fixed quote after the discovery call, not an hourly meter."),
  ("How long does a Webflow build take?",
   "Four to six weeks for a typical marketing site from an agreed design. A landing page is one to two weeks. Content readiness is usually what moves the date, not the build."),
 ...
 "Production Webflow development with an editor-proof CMS. 6-12 page marketing sites, $2,500-$6,000, four to six weeks. Migration, QA and launch support included.",
...
service_page(
 ...
 "Framer development for landing pages and marketing sites that have to ship on a date: a launch page live in one to two weeks from $900, a full marketing site in three to four. Built for fundraises, product launches and announcements, with real motion, a working CMS and performance that holds up.",
 ...
 [("Framer or Webflow &#8212; which should I choose?",
  ...
  ("How fast can a Framer site go live?",
   "A focused landing page can be live in one to two weeks from an agreed design, a full marketing site in three to four. The bottleneck is almost always copy and assets, so we agree those first."),
 ...
 "Framer development for landing pages and marketing sites. Live in one to two weeks, from $900. Custom motion, CMS, launch support for startups and fundraises.",
...
service_page(
 ...
 "Design and production work on AI-built apps: Lovable, v0, Bolt and Claude Code prototypes taken to something you can ship. $1,500-$4,000, two to five weeks.",
